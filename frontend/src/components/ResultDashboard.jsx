...
// --- Formats numbers with Mexico locale (thousands separator, decimals) ---
...
export default function ResultDashboard({ result }) {
  // Empty state: shown when nothing has been solved yet
  if (!result) {
    return (
  ...
  return (
    <section className="dashboard">
      ...
      {/* Textual interpretation generated by the backend */}
      <article className="interpretation-card">
        <h2>Interpretación</h2>
        <p>{result.interpretation}</p>
      </article>

      {/* Optimal values table for each variable */}
      ...
      {/* Constraint analysis table: activity, slack, status */}
